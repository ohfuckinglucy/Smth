...
int main(int argc, char *argv[]) {
    ...
    // функция для перемещения указателя в какую-то часть файла (в данном случае в конец).
    fseek(input_file, 0, SEEK_END); 

    // функция для сообщения где находится указатель (в данный момент возвращает размер файла).   
