...
int main() {
    ...
    // Вставка 50,000 элементов по возрастанию
    ...
    printf("Высота дерева после вставки 50,000 элементов по возрастанию: %d\n", rbtree_height(root));

    // Удаление 10 случайных узлов
    ...
    printf("Высота дерева после удаления 10 узлов: %d\n", rbtree_height(root));
